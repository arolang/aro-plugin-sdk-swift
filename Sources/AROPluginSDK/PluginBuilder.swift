...
public enum AROPluginExport {
    public nonisolated(unsafe) static var shared: AROPlugin?
...
// NOTE: The @_cdecl auto-export entry points are in the AROPluginSDKExport target.
// Import AROPluginSDKExport (instead of AROPluginSDK) for zero-boilerplate plugins.
// Import AROPluginSDK directly when your plugin has its own @_cdecl exports.
